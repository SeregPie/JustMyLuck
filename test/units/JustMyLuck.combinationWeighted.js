...
module.exports = function() {
	...
	assert.deepEqual(JustMyLuck.combinationWeighted([], -4), []);
	assert.deepEqual(JustMyLuck.combinationWeighted([], 0), []);
	assert.deepEqual(JustMyLuck.combinationWeighted([], 1), []);
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 1]], -4), []);
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 1]], 0), []);
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 1]], 1), ['a']);
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 1]], 3), ['a']);
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 3], ['b', 1], ['c', 2]], -4), []);
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 3], ['b', 1], ['c', 2]], 0), []);
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 3], ['b', 1], ['c', 2]], 3), ['a', 'b', 'c']);
	...
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 0], ['b', 1], ['c', -4]], 1), ['b']);
	assert.deepEqual(JustMyLuck.combinationWeighted([['a', 0], ['b', 1], ['c', -4]], 3), ['a', 'b', 'c']);
};
